"""
`registrable.Registrable` is a "mixin" for endowing
...
from poros.poros_common.checks import ConfigurationError
from poros.poros_common.from_params import FromParams
