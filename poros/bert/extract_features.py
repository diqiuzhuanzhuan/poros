...
if __name__ == "__main__":
    ...
    params = ["--input_file=./sample_text.txt",
              "--vocab_file=../bert_model/data/chinese_L-12_H-768_A-12/vocab.txt",
              "--bert_config_file=../bert_model/data/chinese_L-12_H-768_A-12/bert_config.json",\
              "--init_checkpoint=../bert_model/data/chinese_L-12_H-768_A-12",
              "--output_file=../bert_model/data/output.feature"]
    argv = sys.argv
    argv = argv + params
    absl.app.run(main=main, argv=argv)
